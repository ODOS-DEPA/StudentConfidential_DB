...
//this is version 4, the latest version for StudentTable.jsx o7
//search button with dash if null in table stage 1-8 with switch case for stage fields 1 means pass 0 means fail and null means no value ("-")
import React, { useEffect, useState } from 'react';
import axios from 'axios';
import SearchBar from './SearchBar';
