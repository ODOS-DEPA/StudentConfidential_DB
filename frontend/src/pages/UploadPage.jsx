...
//fixing the logic for determining status
                    ...
                    >
                      {columns.map((key, j) => {
                        ...
                        if (keyLower.startsWith('stage') && keyLower !== 'currentstatus') {
                          ...
                          if (value === 1 || value === '1' || String(value).trim() === 'ผ่าน') {
                            displayVal = '✅';
                          } else if (value === 0 || value === '0' || String(value).trim() === 'ไม่ผ่าน') {
                            displayVal = '❌';
                          } else if (String(value).trim() === 'ติดเงื่อนไข') {
                            displayVal = '⚠️';
                          } else if (String(value).trim() === 'รอ' || String(value).trim() === 'waiting' || String(value).trim() === 'รอดำเนินการ' || value === null || value === undefined || value === '' || String(value).toLowerCase() === 'null') {
                            displayVal = '⌛';
                          } else {
                            displayVal = '⌛';
                          }
